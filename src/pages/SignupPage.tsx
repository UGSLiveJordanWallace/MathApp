...
export default function SignupPage() {
    ...
    return (
        <>
            ...
            <Form
                className="relative flex flex-col gap-1 p-3 bg-white rounded-sm"
            ...
            >
                ...
                <input
                    className="text-lg bg-gray-100 border-b-1 focus:border-b-2 focus:outline-hidden"
                    type="password"
                ...
                <NavLink
                    className="block w-full text-center text-blue-400"
                    to="/login"
                >
